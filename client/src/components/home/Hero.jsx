            ...
            <div className="min-h-screen pb-20">
                ...
                <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                    <a href="https://prebuiltui.com">
                        <img src = "/resumaid.svg" alt = "logo" className="h-25 w-auto"/>
                    </a>
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <div className="flex flex-col items-center mt-8">
                        <img 
                            src="https://i.postimg.cc/fTVFdVfx/resume-icon-solid-purple-black-business-symbol-illustration-free-vector.jpg" 
                            alt="Favicon" 
                            className="rounded-full w-32 h-32 object-cover border-4 border-indigo-500"
                        />
                        <p className="text-sm text-slate-500 mt-4">
                            This academic project is for educational purposes only. Not intended for commercial use.
                        </p>
                    </div>
