...
const Features = () => {
  ...
  return (
    <div id = 'features' className="flex flex-col items-center my-10 scroll-mt-12">
        ...
        <Title title='Build your resume' description='Our streamlined process helps you create a professional resume in minutes with the help of intelligent AI-powered tools.'/>
                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Real-Time Overview</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Get instant overview of your resume as you build it.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Customize Your Future</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Choose a variety of customization methods for your resume.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Instant Exports</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Export professional, AI-tailored resumes that fit your needs.</p>
                            </div>
                        </div>
                    </div>
                </div>
